...
const Dashboard: React.FC = () => {
  ...
  const EmergencyContactContent = () => (
    <div className="p-6">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">紧急联系</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
              <div className="flex justify-between items-start">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">张小明</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">配偶</p>
                  <p className="text-sm text-gray-500">📞 138-0000-1234</p>
                </div>
                <span className="bg-red-100 text-red-800 px-2 py-1 rounded text-xs">主要</span>
              </div>
            </div>
            <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
              <div className="flex justify-between items-start">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">李大华</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">父亲</p>
                  <p className="text-sm text-gray-500">📞 139-0000-5678</p>
                </div>
                <span className="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs">次要</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="space-y-3">
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">血型</label>
              <p className="text-gray-900 dark:text-white">O型</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">过敏史</label>
              <p className="text-gray-900 dark:text-white">青霉素过敏</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                慢性疾病
              </label>
              <p className="text-gray-900 dark:text-white">高血压</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                常用药物
              </label>
              <p className="text-gray-900 dark:text-white">降压药（每日一次）</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
              <span className="font-medium">急救中心</span>
              <span className="text-red-600 font-bold">120</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <span className="font-medium">医院总机</span>
              <span className="text-blue-600 font-bold">400-123-4567</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
              <span className="font-medium">主治医生</span>
              <span className="text-green-600 font-bold">138-0000-9999</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-gray-900 dark:text-white font-mono">1234567890123456</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                身份证号
              </label>
              <p className="text-gray-900 dark:text-white font-mono">110101199001011234</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">病历号</label>
              <p className="text-gray-900 dark:text-white font-mono">MR2024001234</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      // 医生专用功能
      case 'patients':
        return <UserManagementContent />; // 患者管理，复用用户管理组件
      case 'diagnosis':
